  ...
  return (
    <div className="about">
      ...
      <h2 className="content">
        ...
        <br /> I graduated from my master's in sustainable Architecture from{" "}
        <a
        ...
        , I took a year of exchange in Finland at the{" "}
        <a
        ...
        development, starting by taking courses online in HTML, CSS, JS and
        UX/UI. The more I learned about IT, the more I realized I wanted to
        learn more, so I joined a web development bootcamp offered by an amazing
        organization called{" "}
        <a
      ...
      <h2 className="content">
        {" "}
        I love co-creating so if you want to collaborate drop me a line at →{" "}
